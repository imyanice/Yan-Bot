...
module.exports = class Hi extends BaseCommand {
  ...
  async run(client, interaction) {
    ...
    if (!interaction.options[0]) {
      ...
      .addField("\u200B", '<:YJ_logo:831533916979593258> Dev by " Yan Jobs#0001 | Source code [here](https://github.com/Yan-Jobs/Yan-Bot) | Open Source :hearts: ');
      await interaction.reply(embed);
    } else if (interaction.options[0].value === "fun") {
      embed.setTitle('<:YJ_fun:846032578745335848>  Fun commands')
        .setDescription(
      ...
      embed.setTitle('<:YJ_moderation:846044206077575209>  Moderation commands')
        .setDescription(
